...
public class TetrisShape7 extends TetrisShape {

	public TetrisShape7 (Rectangle[][] array, Pane pane) {
	...
	public void setUpInitialLocation() {
		this.getRectangle1().setFill(Color.BLUE);
		this.getRectangle2().setFill(Color.BLUE);
		this.getRectangle3().setFill(Color.BLUE);
		this.getRectangle4().setFill(Color.BLUE);
		this.getRectangle1().setX(Constants.TETRIS_SHAPE_LOCATION_SET[24][0]);
		this.getRectangle1().setY(Constants.TETRIS_SHAPE_LOCATION_SET[24][1]);
		this.getRectangle2().setX(Constants.TETRIS_SHAPE_LOCATION_SET[25][0]);
		this.getRectangle2().setY(Constants.TETRIS_SHAPE_LOCATION_SET[25][1]);
		this.getRectangle3().setX(Constants.TETRIS_SHAPE_LOCATION_SET[26][0]);
		this.getRectangle3().setY(Constants.TETRIS_SHAPE_LOCATION_SET[26][1]);
		this.getRectangle4().setX(Constants.TETRIS_SHAPE_LOCATION_SET[27][0]);
		this.getRectangle4().setY(Constants.TETRIS_SHAPE_LOCATION_SET[27][1]);
	...
	public void Rotate() {
		...
		double centerOfLocationX = this.getRectangle1().getX();
		double centerOfLocationY = this.getRectangle1().getY();
