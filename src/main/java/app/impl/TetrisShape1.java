...
public class TetrisShape1 extends TetrisShape {

	public TetrisShape1(Rectangle[][] array, Pane pane) {
	...
	public void setUpInitialLocation() {
		this.getRectangle1().setFill(Color.RED);
		this.getRectangle2().setFill(Color.RED);
		this.getRectangle3().setFill(Color.RED);
		this.getRectangle4().setFill(Color.RED);
		this.getRectangle1().setX(Constants.TETRIS_SHAPE_LOCATION_SET[0][0]);
		this.getRectangle1().setY(Constants.TETRIS_SHAPE_LOCATION_SET[0][1]);
		this.getRectangle2().setX(Constants.TETRIS_SHAPE_LOCATION_SET[1][0]);
		this.getRectangle2().setY(Constants.TETRIS_SHAPE_LOCATION_SET[1][1]);
		this.getRectangle3().setX(Constants.TETRIS_SHAPE_LOCATION_SET[2][0]);
		this.getRectangle3().setY(Constants.TETRIS_SHAPE_LOCATION_SET[2][1]);
		this.getRectangle4().setX(Constants.TETRIS_SHAPE_LOCATION_SET[3][0]);
		this.getRectangle4().setY(Constants.TETRIS_SHAPE_LOCATION_SET[3][1]);
