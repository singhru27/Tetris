...
public class TetrisShape4 extends TetrisShape {

	public TetrisShape4(Rectangle[][] array, Pane pane) {
	...
	public void setUpInitialLocation() {
		this.getRectangle1().setFill(Color.YELLOW);
		this.getRectangle2().setFill(Color.YELLOW);
		this.getRectangle3().setFill(Color.YELLOW);
		this.getRectangle4().setFill(Color.YELLOW);
		this.getRectangle1().setX(Constants.TETRIS_SHAPE_LOCATION_SET[12][0]);
		this.getRectangle1().setY(Constants.TETRIS_SHAPE_LOCATION_SET[12][1]);
		this.getRectangle2().setX(Constants.TETRIS_SHAPE_LOCATION_SET[13][0]);
		this.getRectangle2().setY(Constants.TETRIS_SHAPE_LOCATION_SET[13][1]);
		this.getRectangle3().setX(Constants.TETRIS_SHAPE_LOCATION_SET[14][0]);
		this.getRectangle3().setY(Constants.TETRIS_SHAPE_LOCATION_SET[14][1]);
		this.getRectangle4().setX(Constants.TETRIS_SHAPE_LOCATION_SET[15][0]);
		this.getRectangle4().setY(Constants.TETRIS_SHAPE_LOCATION_SET[15][1]);
