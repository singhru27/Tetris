...
public class TetrisShape5 extends TetrisShape {

	public TetrisShape5(Rectangle[][] array, Pane pane) {
	...
	public void setUpInitialLocation() {
		this.getRectangle1().setFill(Color.GREEN);
		this.getRectangle2().setFill(Color.GREEN);
		this.getRectangle3().setFill(Color.GREEN);
		this.getRectangle4().setFill(Color.GREEN);
		this.getRectangle1().setX(Constants.TETRIS_SHAPE_LOCATION_SET[16][0]);
		this.getRectangle1().setY(Constants.TETRIS_SHAPE_LOCATION_SET[16][1]);
		this.getRectangle2().setX(Constants.TETRIS_SHAPE_LOCATION_SET[17][0]);
		this.getRectangle2().setY(Constants.TETRIS_SHAPE_LOCATION_SET[17][1]);
		this.getRectangle3().setX(Constants.TETRIS_SHAPE_LOCATION_SET[18][0]);
		this.getRectangle3().setY(Constants.TETRIS_SHAPE_LOCATION_SET[18][1]);
		this.getRectangle4().setX(Constants.TETRIS_SHAPE_LOCATION_SET[19][0]);
		this.getRectangle4().setY(Constants.TETRIS_SHAPE_LOCATION_SET[19][1]);
	...
	public void Rotate() {
		...
		double centerOfLocationX = this.getRectangle3().getX();
		double centerOfLocationY = this.getRectangle3().getY();
